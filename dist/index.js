(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.countdown = {}));
	...
	***************************************************************************** */
	...
	var BaseAdapter = /** @class */ (function () {
	    function BaseAdapter(startTime, endTime, callback) {
	    ...
	    Object.defineProperty(BaseAdapter.prototype, "date", {
	        get: function () {
	    ...
	    Object.defineProperty(BaseAdapter.prototype, "hour", {
	        get: function () {
	    ...
	    Object.defineProperty(BaseAdapter.prototype, "minute", {
	        get: function () {
	    ...
	    Object.defineProperty(BaseAdapter.prototype, "second", {
	        get: function () {
	...
	var Interval = /** @class */ (function (_super) {
	    ...
	    function Interval(startTime, endTime, callback, delay) {
	        var _this = _super.call(this, startTime, endTime, callback) || this;
	        _this.time = performance.now();
	        _this.ensureDelay(delay);
	        return _this;
	    }
	    Interval.prototype.ensureDelay = function (time) {
	        var delay = DELAY;
	        if (time !== undefined) {
	            delay = time;
	        }
	    ...
	    Interval.prototype.step = function (timestamp) {
	        if (!this.running)
	            return;
	    ...
	    Interval.prototype.calculate = function (timestamp) {
	    ...
	    Interval.prototype.onDidIdleExecute = function (timestamp) {
	    ...
	    Interval.prototype.onDidCarryCalculate = function () {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.formatCountdown = exports.formatTimeStr = exports.format = exports.subtract = exports.getTime = void 0;
	...
	function format(timestamp) {
	    return {
	        year: Math.floor(timestamp / 1314000000 /* YEAR */),
	        month: Math.floor(timestamp / 108000000 /* MONTH */),
	        week: Math.floor(timestamp / 25200000 /* WEEK */),
	        day: Math.floor(timestamp / 3600000 /* DAY */),
	        hour: Math.floor(timestamp / 60000 /* HOUR */),
	        minute: Math.floor(timestamp / 60000 /* MINUTE */),
	        second: Math.floor(timestamp / 1000 /* SECOND */),
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.isValidDate = exports.isString = exports.isFunction = void 0;
	...
	function pruneAdapterOptions(args) {
	    ...
	    if (!start) {
	        start = libs.getTime().toDate();
	    }
	    return {
	        start: start,
	        end: libs.getTime(args.end).toDate(),
	        callback: args.callback,
	        delay: args.delay
	    };
	}
	var createApp = function (args) {
	    var adapterOptions = pruneAdapterOptions(args);
	    var app = ensureAdapter(adapterOptions);
	    return app;
	};
